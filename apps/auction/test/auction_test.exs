defmodule AuctionTest do
  ...
  describe "list_items/0" do
    setup do
      {:ok, item1} = Repo.insert(%Item{title: "Item1"})
      {:ok, item2} = Repo.insert(%Item{title: "Item2"})
      {:ok, item3} = Repo.insert(%Item{title: "Item3"})
  ...
  describe "insert_item/1" do
    ...
    test "the item inserted has the attributes provided" do
